// coffee_shop.c
//
// This program was written by Sofia De Bellis (z5418801) Thanks Sofia :)
// on Febuarary 2024
//
...
int main(void) {
    struct coffee order;
    printf("Enter coffee type (0: LATTE, 1: CAPPUCCINO, 2: ESPRESSO, 3: AMERICANO, 4: MATCHA): ");
    
    scanf("%d", &order.type);

	// You can do this if you want to check if the user input is valid
    // int type;
	// scanf("%d", &type);
    // if (type == 0) {
    //     order.type = LATTE;
